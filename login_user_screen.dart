...
class _LoginUserScreenState extends State<LoginUserScreen>
  ...
  // ── Firebase Authentication se login karo ─────────────────────
  Future<void> login() async {
    if (emailController.text.isEmpty || passwordController.text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          backgroundColor: const Color(0xFF8A5F9A),
    ...
    try {
      ...
      // ── Login successful: dashboard par jao ───────────────────
      if (mounted) {
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // ── Login Button (loading state ke sath) ──
                              GestureDetector(
