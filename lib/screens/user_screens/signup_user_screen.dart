...
class _SignupUserScreenState extends State<SignupUserScreen>
  ...
  void _createAccount() {
    // 🔴 Backend — Phase 2: Firebase save all data
  ...
  final List<Map<String, dynamic>> _stepMeta = [
    ...
    },
    {
      ...
      'title': 'Safety Setup',
      'subtitle': 'Guardian & emergency contacts',
    },
    {
      'icon': Icons.devices_rounded,
      'title': 'Device & Account',
      'subtitle': 'Link your safety device',
    },
  ];
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  "Device ID is printed on your ESP32 safety device label.",
